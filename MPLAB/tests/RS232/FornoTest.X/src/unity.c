...
typedef char    jmp_buf_test[4];
void 
longjmp_test(jmp_buf_test jp, int retval)
{
...
#define UNITY_FAIL_AND_BAIL   { Unity.CurrentTestFailed  = 1; longjmp_test(Unity.AbortFrame, 1); }
#define UNITY_IGNORE_AND_BAIL { Unity.CurrentTestIgnored = 1; longjmp_test(Unity.AbortFrame, 1); }
...
static const _UF f_zero = 0.00001f;
